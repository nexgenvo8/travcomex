    ...
    return (
      <TouchableOpacity
        ...
        <View
          ...
          <Text style={{color: colors.textColor}}>{item?.Serviceoffered}</Text>
        </View>
        <View
          style={{
            marginTop: 10,
          ...
          <Text style={{color: colors.textColor}}>{item?.WorkExperience}</Text>
        </View>
                      ...
                      <View
                        ...
                        <View style={globalStyles.flexRow}>
                          <TouchableOpacity
                            ...
                            <Text
                              style={{...styles.saveText, color: Colors.black}}>
                              Cancel
                            </Text>
                          </TouchableOpacity>
                          <TouchableOpacity
